...
Builds and controls the transmit-side pipeline (Pi 3B):
  ...
  libcamerasrc -> videoconvert -> v4l2h264enc -> h264parse -> rtph264pay
      -> rtpbin -> udpsink (RTP)
...
class TxPipeline:
    ...
    def _on_app_rtcp(self, *args):
        # placeholder: some rtpbin versions emit custom app RTCP; not used yet
        pass
